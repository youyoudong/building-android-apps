= Building Android apps image:https://travis-ci.org/gradle-guides/building-android-apps.svg?branch=master["Build Status", link="https://travis-ci.org/gradle-guides/building-android-apps?branch=master"]
